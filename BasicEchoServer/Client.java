...
arguemnt (the server will also be run on this machine, though you could change "localhost" to any hostname).
...
it's TCP connection to the server. You can run the Client class again while the server is still running.
