...
port number given as a command line argument. The server waits continuously for new Socket connections
with new clients. After creating a connection, this program reeieves a line of text,
captializes it, and sends it back to the client through the Socket's output stream. This program then
...
public class Server {
	...
	public static void main(String[] args) throws UnknownHostException, IOException {
		...
		// receieve port number as argument
		if (args.length != 1){
